...
const Home = () => {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col items-center bg-background-primary'>
        <h1 className="mt-8 text-4xl font-bold text-gray-800 text-center">Welcome to Chat App</h1>
        <p className="text-gray-600 mt-2 text-center">Connect with your friends anytime, anywhere.</p>
